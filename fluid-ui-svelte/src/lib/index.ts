...
export { default as Form } from "$lib/primitives/Form.svelte";
export { default as Image } from "$lib/primitives/Image.svelte";
export { default as Input } from "$lib/primitives/Input.svelte";
export { default as Label } from "$lib/primitives/Label.svelte";
export { default as Table } from "$lib/primitives/Table.svelte";
export { default as TableBody } from "$lib/primitives/TableBody.svelte";
export { default as TableData } from "$lib/primitives/TableData.svelte";
export { default as TableFooter } from "$lib/primitives/TableFooter.svelte";
export { default as TableHead } from "$lib/primitives/TableHead.svelte";
export { default as TableHeader } from "$lib/primitives/TableHeader.svelte";
export { default as TableRow } from "$lib/primitives/TableRow.svelte";
export { default as Text } from "$lib/primitives/Text.svelte";
export { default as TextArea } from "$lib/primitives/TextArea.svelte";
